...
$lang = array_merge($lang, array(
  ...
  'ACP_SN_LIKE_US_FB'						=> 'Like phpBB Social Network on Facebook',
	...
	'SN_ACP_NOTHING_TO_SET'					 => 'This module have nothing to set',
...
$lang = array_merge($lang, array(
	...
	'IM_AUTOMATIC_PURGING_MESSAGES_EXPLAIN'	 => 'Delivered messages are automatically deleted when they are older than X days.<br />Insert 0 to disable auto-pruning old messages',

	'PURGE'									 => 'Purging',

	'IM_PURGE_ALL_MSG'						 => 'Delete old delivered messages',
	'IM_PURGE_ALL_MSG_EXPLAIN'				 => 'All delivered messages older then X days will be deleted<br />Minimal value is 1 day',
	'IM_PURGE_ALL_MSG_SUCCESS'				 => 'All old delivered messages have been deleted',

	'IM_PURGE_ALL_CHATBOX'					 => 'Close all opened chatboxes',
	'IM_PURGE_ALL_CHATBOX_EXPLAIN'			 => 'All opened chatboxes older then X days will be closed<br />Minimal value is 1 day',
	...
	'IM_CHECK_TIME_MIN_EXPLAIN'				 => 'Minimum time to check for new messages',
	'IM_CHECK_TIME_MAX_EXPLAIN'				 => 'Maximum time to check for new messages',
));
