...
$lang = array_merge($lang, array(
	/**
	 * Edit these two lines write your own Welcome text for unregistered guests on Mainpage.
	 */
	'SN_MP_WELCOME_TITLE'					 => 'Welcome to our web!',
	'SN_MP_WELCOME_TEXT'					 => 'Feel free to register and use all of the features of our website.<br /><br />Greetings,<br />the Administrator',
	...
	'SN_IM_CHAT'							 => 'Chat',
	'SN_IM_NO_ONLINE_USER'					 => 'No online user',
	...
	'SN_CB_FETCH_ERROR'						 => 'An error encountered by fetching the web page',
	'SN_US_FETCH_NO_DESCRIPTION'			 => 'No description',

	'SN_MP_MAINPAGE'						 => 'Mainpage',
	'SN_MP_AND'								 => 'and',
	'SN_MP_ARE_FRIENDS'						 => 'are now friends.',
	'SN_MP_ADD_AS_FRIEND'					 => 'Add as Friend',
	'SN_MP_PRIVATE_MESSAGE'					 => 'Messages',
	'SN_MP_MANAGE_PROFILE'					 => 'Edit My Profile',
	'SN_MP_VIEW_FRIENDS'					 => 'View My Friends',
	'SN_MP_VIEW_SUGGESTIONS'				 => 'People You May Know',
	'SN_MP_MANAGE_FRIENDS'					 => 'Manage Friends',
	'SN_MP_BOARD'							 => 'Discussion Board',
	'SN_MP_VIEW_MEMBERLIST'					 => 'View Members',
	'SN_MP_LOG_OUT'							 => 'Log Out',
	'SN_MP_LAST_POSTS'						 => 'Recent discussions',
	'SN_MP_TOTAL_FRIEND'					 => 'You have 1 friend',
	'SN_MP_TOTAL_FRIENDS'					 => 'You have %s friends',
	'SN_MP_FRIEND_SUGGESTIONS'				 => 'People you may know',
	'SN_MP_REQUESTS_LIST'					 => 'Requests',
	'SN_MP_ONLINE_FRIENDS'					 => 'Friends online',
	'SN_MP_NO_ONLINE_USER'					 => 'No users online',
	'SN_MP_NO_DISCUSSION'					 => 'No recent discussions',
	'SN_MP_NO_ENTRY'						 => 'Nothing new here',
	'SN_MP_LOAD_NEWS'						 => 'Load new',
	'SN_MP_SEE_ALL'							 => 'View All',
	'SN_MP_NO_FRIENDS'						 => 'You have no friends',
	'SN_MP_KEEP_LOGGEDIN'					 => 'Keep me logged in',
	'SN_MP_STATISTICS'						 => 'Statistics',
	'SN_MP_TOTAL_USERS'						 => '<strong>%d</strong> members',
	'SN_MP_TOTAL_POSTS'						 => '<strong>%d</strong> posts',
	'SN_MP_TOTAL_TOPICS'					 => '<strong>%d</strong> topics',
	'SN_MP_TOPICS_PER_DAY'					 => '<strong>%d</strong> topics per day',
	'SN_MP_POSTS_PER_DAY'					 => '<strong>%d</strong> posts per day',
	'SN_MP_USERS_PER_DAY'					 => '<strong>%d</strong> users per day',
	'SN_MP_BIRTHDAY'						 => 'Birthday',
	'SN_MP_BIRTHDAY_1'						 => 'birthday %1$s',
	'SN_MP_BIRTHDAY_2'						 => 'birthday on %1$s',
	'SN_MP_BIRTHDAY_USERNAME'				 => '%1$s\'s',
	'SN_MP_WELCOME'							 => 'Welcome',
	'SN_MP_VIEWING_MAINPAGE'				 => 'Viewing mainpage',
	'SN_MP_NO_SUGGESTIONS'					 => 'There are no friend suggestions for you',
	'SN_MP_CHANGED_HIS_PROFILE'				 => 'has updated his profile.',
	'SN_UP_CHANGED_HIS_AVATAR'				 => 'has changed his profile picture.',
	'SN_MP_ADDED_NEW_FAMILY_MEMBER'			 => 'has added %1$s (%2$s) as a new family member to his profile.',
	'SN_MP_CHANGED_HIS_RELATIONSHIP'		 => 'has added a new relationship to his profile',
	...
	'SN_UP_APPROVE_RELATION_ERROR_APPROVED'	 => 'This relationship has been already approved',
	...
	'SN_UP_APPROVE_FAMILY_TEXT'				 => '%2$s has added you as a <strong>%3$s</strong>.<br /><br />%1$sYou can approve this relation here%4$s',
	'SN_UP_APPROVE_FAMILY_CONFIRM'			 => 'Are you sure you want to approve this relation?',
	'SN_UP_APPROVE_FAMILY_ERROR_CANCELED'	 => 'This relation has been canceled',
	'SN_UP_APPROVE_FAMILY_ERROR_MYSELF'		 => 'You can not add yourself as your family member',
	'SN_UP_APPROVE_FAMILY_ERROR_APPROVED'	 => 'This relation has been already approved.',
	...
	'TOO_SHORT_FACEBOOK'					 => 'The Facebook adress you entered is too short, a minimum of 12 characters is required.',
	'TOO_SHORT_TWITTER'						 => 'The Twitter adress you entered is too short, a minimum of 12 characters is required.',
	'TOO_SHORT_YOUTUBE'						 => 'The Youtube adress you entered is too short, a minimum of 12 characters is required.',
	...
	'SN_UP_REPORT_SUCCESS'					 => 'User has been reported succesfully',
	'SN_UP_CAN_LEAVE_BLANK'					 => 'This can be left blank.',
	'SN_UP_MORE_INFO'						 => 'Further information',
	'SN_UP_SUBSCRIBE'						 => 'Subscribe',
	'SN_UP_UNSUBSCRIBE'						 => 'Unsubscribe',
...
$lang = array_merge($lang, array(
	...
	'IM_NO_HISTORY'							 => 'In recorded history, you have no record of communication',
	'IM_HISTORY_WITH'						 => 'History with',
	'IM_MSG_TOTAL'							 => '1 message',
	'IM_MSGS_TOTAL'							 => '%1$s messages',
	'IM_SOUND_SELECT_NAME'					 => 'Select sound',
	'EXPORT_IM_HISTORY'						 => 'Export Instant Messenger history',
	...
	'FRIENDS_APPROVALS_SUCCESS'				 => 'The friend has been added succesfully',
	'FRIENDS_APPROVALS_REQUEST_EXIST'		 => 'You have already sent the request to this user',
	'FRIENDS_APPROVALS_DENY'				 => 'The friend request has been canceled succesfully',
	'FRIENDS_APPROVALS_REMOVE'				 => 'The friend has been removed succesfully',
	'FRIENDS_APPROVALS_ADDED'				 => 'The friend request has been send succesfully',
	...
	'UFG_CREATE_EXPLAIN'					 => 'You can create a friends group here to divide your friends to groups.',
...
$lang = array_merge($lang, array(
	...
	'SN_UP_CLOSE_REPORTS_SUCCESS'	 => 'Reports hav been closed successfully.',
...
$lang = array_merge($lang, array(
	...
	'SN_NTF_STATUS_FRIEND_WALL'		 => '%1$s has left a message on <a href="%2$s">your wall</a>',

	'SN_NTF_APPROVE_FAMILY'			 => '%1$s has added you as a %2$s. <a href="%3$s">Approve this relation here</a>',
	'SN_NTF_APPROVE_RELATIONSHIP'	 => '%1$s has created a relationship with you. <a href="%2$s">Approve this relation here</a>',
));
