	...
	function main($id)
	{
		...
		$display_vars = array(
			...
			'vars'	 => array(
				...
				'im_msg_purged_automatic_time'	 => array('lang' => 'IM_AUTOMATIC_PURGING_MESSAGES', 'validate' => 'int', 'type' => 'text:3:4', 'append' => ' ' . $user->lang['DAYS'], 'explain' => true),
				'im_colour_username'			 => array('lang' => 'SN_COLOUR_NAME', 'validate' => 'bool', 'type' => 'radio:yes_no', 'explain' => true),
				'legend2' => 'SN_IM_CHECKTIMES',
				'im_checkTime_min'				 => array('lang' => 'IM_CHECK_TIME_MIN', 'validate' => 'int', 'type' => 'text:3:4', 'append' => ' ' . $user->lang['SECONDS'], 'explain' => true),
				'im_checkTime_max'				 => array('lang' => 'IM_CHECK_TIME_MAX', 'validate' => 'int', 'type' => 'text:3:4', 'append' => ' ' . $user->lang['SECONDS'], 'explain' => true),
